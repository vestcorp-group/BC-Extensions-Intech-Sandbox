// report 58239 "Counting Sheet1"//T12370-Full Comment
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = 'Inventory Counting/Report/Layout/CountingSheet.rdl';
...
//                 ItemUOM.Reset();
//                 ItemUOM.SetCurrentKey("Item No.", "Qty. per Unit of Measure", "Variant Code"); // Variant Code added by baya
//                 ItemUOM.SetRange("Item No.", "Item No.");
//                 ItemUoM.SetFilter("Variant Code", '%1|%2', '', "Variant Code"); // added by baya
