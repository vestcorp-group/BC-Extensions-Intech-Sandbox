report 58159 ST04_WarehouseInvreportNew //T13413-Full UnComment     //T12370-Full Comment  took from Intech-Devlopment(50106) instead of Old Report
{
    UsageCategory = Administration;
    ApplicationArea = All;
    // Caption = 'ST04 Warehouse Inventory Report New';
    Caption = 'Warehouse Inventory Report';
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/ST04 WarehouseInventoryreportNew.rdl';
                ...
                "Reservation Entry")
                {
                    ...
                    begin
                        ...
                        CASE "Source Type" OF
                            DATABASE::"Sales Line":
                                BEGIN
                                    If SalesLineL.GET("Source Subtype", "Source ID", "Source Ref. No.") then;
                                    if CustomerL.get(SalesLineL."Sell-to Customer No.") then;
                            ...
                            DATABASE::"Purchase Line":
                                BEGIN
                                    if PurchaseLineL.GET("Source Subtype", "Source ID", "Source Ref. No.") then;
                                    if VendorL.Get(PurchaseLineL."Buy-from Vendor No.") then;
