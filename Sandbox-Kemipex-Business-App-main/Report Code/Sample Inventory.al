report 58201 Det_SampleInventoryReport//T12370-Full Comment     //T13413-Full UnComment
{
    UsageCategory = Administration;
    ApplicationArea = All;
    Caption = 'Sample Inventory Detailed  Report';
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Sample_Inventory.rdl';
    //RDLCLayout = 'Reports/Warehouse/Sample_Inventory.rdl';
    dataset
    {
        dataitem(ItemLedEntryTemp; "Item Ledger Entry")
        {
            ...
            begin
                ...
                if CountryName.Get(ItemLedEntryTemp."Country/Region Code") then;
