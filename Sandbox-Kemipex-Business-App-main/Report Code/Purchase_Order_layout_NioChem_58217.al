// report 58217 "Purchase Order Niochem"//T12370-Full Comment
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = 'Reports/Purchase Order NioChem.rdl';
...
//                     TotalCaption := StrSubstNo('Total Amount Payable in %1', "Currency Code");
//                     ExchangeRate := StrSubstNo('Currency exchange rate: %1 %2', "Currency Code", ROUND(1 / "Currency Factor", 0.00001, '='));
...
//                 End
//                 ELSe begin
//                     TotalCaption := 'Total Amount Payable in AED';
//                     ExchangeRate := '';
//                 End;
...
//         OtherTerms_Lbl = 'Terms and Conditions:';
//         OtherTerms1_Lbl = '1)   All batches require a Certificate of Analysis';
//         OtherTerms2_Lbl = '2)   3 original Bill of Landing and 3 copies to be provided';
//         OtherTerms3_Lbl = '3)   Commercial Invoice and Packing list in two originals and one copy signed and shall be stamped by the supplier';
//         OtherTerms4_Lbl = '4)   Details of container batch-wise loading need to be provided';
//         OtherTerms5_Lbl = '5)   Legalization of documents are not required for this order';
//         OtherTerms6_Lbl = '6)   Certificate of Origin in 1 original and 1 copy to be provided by Chamber of commerce';
...
//         Remark_1_LBL = '* We reserve the right to request for quality inspections of certain batches by third party at our own cost';
//         Remark_2_LBL = '* In the event of any deviation from the given ETD above, notify us as soon as possible for any required coordination';
//         Remark_3_LBL = '* Purchase Order Ref. must be quoted on all related documents and correspondences for tracking purposes.';
