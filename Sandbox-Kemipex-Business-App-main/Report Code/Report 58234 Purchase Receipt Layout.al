...
report 58234 "Posted Purchase - Receipt"//T12370-Full Comment  //T13574 Code unocommented
{
    // version NAVW113.00
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Posted Purchase - Receipt.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        begin
                            ...
                            if "Variant Code" <> '' then begin // add by bayas
                                // VariantRec.Get("No.", "Variant Code");
                                ItemUoML.Get("Purch. Rcpt. Line"."No.", "Purch. Rcpt. Line"."Unit of Measure Code");

                                GrossWeightG := ("Purch. Rcpt. Line".Quantity * ItemUoML."Net Weight") + ("Purch. Rcpt. Line".Quantity * ItemUoML."Packing Weight");
                                GrossTotalG += GrossWeightG;
                            end else begin
                                GrossTotalG += GrossWeightG;
                            end;
                            ...
                            if ItemUoML.FindSet() then
                                repeat
                                    ...
                                    if not UnitofMeasureL."Decimal Allowed" then begin
                                        ...
                                        if "Variant Code" <> '' then begin // add by bayas
                                            VariantRec.Get("No.", "Variant Code");
                                            // UOMCodeG := "Purch. Rcpt. Line"."Unit of Measure Code";
                                            UOMCodeG := "Purch. Rcpt. Line"."Base UOM";
                                            UOMQuantityG := "Purch. Rcpt. Line"."Quantity (Base)";
                                        end else begin
            ...
            begin
                ...
                salespersonPurchaser_lRec.SetRange(Code, "Purch. Rcpt. Header"."Purchaser Code");
                if salespersonPurchaser_lRec.FindFirst() then
                    SalesPurchPersonName := salespersonPurchaser_lRec."Short Name";
