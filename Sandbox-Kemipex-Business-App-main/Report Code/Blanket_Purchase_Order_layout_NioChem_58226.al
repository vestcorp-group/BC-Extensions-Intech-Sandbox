// report 58226 "Blanket Purchase Order Niochem"//T12370-Full Comment
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = 'Reports/Blanket Purchase Order NioChem.rdl';
...
//                             if CountryRegRec.Get(Item_LRec."Vendor Country of Origin") then
...
//         OtherTerms1_Lbl = '1)   This document does not serve as official purchase order.';
//         OtherTerms2_Lbl = '2)   This document serve as advance purchase plan.';
//         OtherTerms3_Lbl = '3)   Procurement department will send official Purchase Order for each line item accordingly.';
//         OtherTerms4_Lbl = '4)  ';
//         OtherTerms5_Lbl = '5)  ';
//         OtherTerms6_Lbl = '6)  ';
//         Remarks_Lbl = 'Remarks:';
