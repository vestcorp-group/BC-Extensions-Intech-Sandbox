// pageextension 58017 PostedPurchcrMemoSubform extends "Posted Purch. Cr. Memo Subform"//T12370-Full Comment
// {
//     layout
//     {
//         //GST
...
//         //     exit(DocumentTotals2.GetTotalVATCaption(TotalPurchCrMemoHdr."Currency Code"));
//         // RecGLSetup.GET;
...
//             exit('GSTORVAT,' + DocumentTotals2.GetTotalVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//         else
//             exit(DocumentTotals2.GetTotalVATCaption(TotalPurchCrMemoHdr."Currency Code"))
...
//         // RecGLSetup.GET;
//         // if Rec."Currency Code" <> '' then
//         // exit('GSTORVAT,' + DocumentTotals2.GetTotalExclVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//         // else
...
//             exit('GSTORVAT,' + DocumentTotals2.GetTotalExclVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//         else
//             exit(DocumentTotals2.GetTotalExclVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//     end;
...
//         // RecGLSetup.GET;
//         // if Rec."Currency Code" <> '' then
//         //exit('GSTORVAT,' + DocumentTotals2.GetTotalInclVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//         // else
...
//             exit('GSTORVAT,' + DocumentTotals2.GetTotalInclVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//         else
//             exit(DocumentTotals2.GetTotalInclVATCaption(TotalPurchCrMemoHdr."Currency Code"))
//     end;
...
//         // RecGLSetup.GET;
//         // if Rec."Currency Code" <> '' then
//         //exit('GSTORVAT,' + DocumentTotals2.GetTotalLineAmountWithVATAndCurrencyCaption(TotalPurchCrMemoHdr."Currency Code", TotalPurchCrMemoHdr."Prices Including VAT"))
//         // else
//         //     exit('GSTORVAT,' + DocumentTotals2.GetTotalLineAmountWithVATAndCurrencyCaption(RecGLSetup."LCY Code", TotalPurchCrMemoHdr."Prices Including VAT"));

//         CompanyInfo.GET;
//         if CompanyInfo."Enable GST caption" then
//             exit('GSTORVAT,' + DocumentTotals2.GetTotalLineAmountWithVATAndCurrencyCaption(TotalPurchCrMemoHdr."Currency Code", TotalPurchCrMemoHdr."Prices Including VAT"))
//         else
//             exit(DocumentTotals2.GetTotalLineAmountWithVATAndCurrencyCaption(TotalPurchCrMemoHdr."Currency Code", TotalPurchCrMemoHdr."Prices Including VAT"))
//     end;
...
//         // RecGLSetup.GET;
//         // if Rec."Currency Code" <> '' then
//         //exit('GSTORVAT,' + DocumentTotals2.GetInvoiceDiscAmountWithVATAndCurrencyCaption(Rec.FieldCaption("Inv. Discount Amount"), TotalPurchCrMemoHdr."Currency Code"))
//         // else
...
//             exit('GSTORVAT,' + DocumentTotals2.GetInvoiceDiscAmountWithVATAndCurrencyCaption(Rec.FieldCaption("Inv. Discount Amount"), TotalPurchCrMemoHdr."Currency Code"))
//         else
//             exit(DocumentTotals2.GetInvoiceDiscAmountWithVATAndCurrencyCaption(Rec.FieldCaption("Inv. Discount Amount"), TotalPurchCrMemoHdr."Currency Code"))
//     end;
