page 58001 "Purchase Approver User Setup"//T12370-Full Comment //T12574-N
{
    ApplicationArea = All;
    Caption = 'Purchase Approver User Setup';
    PageType = List;
    SourceTable = "Purchase Approver User Setup";
    UsageCategory = Lists;
    ...
    var
        myInt: Integer;
    begin
        // myInt := SalesWorkflowCod.UpdateWorkflowPriority(Rec);T50306
        if myInt <> 0 then
