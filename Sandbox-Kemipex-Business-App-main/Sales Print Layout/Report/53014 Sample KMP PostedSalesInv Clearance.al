// report 53014 "KMP PostedSalesInv Sample"//T12370-Full Comment
// {
//     //Stamp
//     DefaultLayout = RDLC;
//     RDLCLayout = 'Sales Print Layout/RDL/53014 Sample KMP PostedSalesInv.rdl';
//     Caption = 'Posted Sales Invoice Sample';
...
//             column(ShowDeliveryTerms; ShowDeliveryTerms) { }
...
//                     TranSec_Desc := 'Delivery Terms:' + TranSpec_rec.Text;
...
//                     TranSec_Desc := 'Delivery Terms:' + TranSec_Desc + ', ' + AreaDesc;

//                 if ("Sales Invoice Header"."VAT Bus. Posting Group" = 'C-DZ') OR ("Sales Invoice Header"."VAT Bus. Posting Group" = 'C-LAT-DG') then
...
//                 if ShipmentNo <> '' then
//                     TranSec_Desc := 'Delivery Terms:' + TranSec_Desc + ', ' + ShipmentNo;
...
//                     }
//                     field(ShowDeliveryTerms; ShowDeliveryTerms)
//                     {
//                         ApplicationArea = all;
...
//         Lbl1 = 'Non-Restricted Sample as per IATA.';
//         Lbl2 = 'Sample provided for quality evaluation purpose only. Not for resale.';
//         Lbl3 = 'Technical Data Sheet and Material Safety Data Sheet are attached for easy reference.';
//         Lbl4 = 'Estimated value of products are given for customs declaration purpose only.';
//         Lbl5 = '';
