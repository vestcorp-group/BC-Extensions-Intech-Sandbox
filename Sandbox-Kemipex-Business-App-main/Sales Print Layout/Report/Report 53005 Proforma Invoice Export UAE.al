report 53005 "Proforma Invoice_Export UAE"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/Proforma Invoice_Export.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(UnitofMeasureCode; "Base UOM 2") { } //PackingListExtChange
                                                            // column(UnitPrice; Customeunitprice) { } T52416-O
                column(UnitPrice; NewUnitPrice_gDec) { }
                ...
                begin
                            ...
                            repeat
                                ...
                                if CustomInvoiceG then begin
                                    if ("Customer Requested Unit Price" = SalesLineL."Customer Requested Unit Price") and ("Unit of Measure Code" = SalesLineL."Unit of Measure Code") then begin
                                        ...
                                        //     SalesLineAmountincVat += SalesLineAmountincVat + +(SalesLineAmount * "VAT %" / 100) + FindAmountDiff_lFnc()//T52416-N
                                        // else
                                    ...
                                    if ("Unit Price" = SalesLineL."Unit Price") and ("Unit of Measure Code" = SalesLineL."Unit of Measure Code") then begin
                                        ...
                                        // if MergeChargeItem_gBln then
                                        //     SalesLineAmountincVat += SalesLineAmountincVat + FindAmountDiff_lFnc()//T52416-N
                                        // else
                    ...
                    If Item_LRec.GET("No.") THEN BEGIN
                        ...
                        //ItemUnitofMeasureL.Get("No.", "Unit of Measure Code");//Hypercare-050325-O
                        // ItemUnitofMeasureL.Ascending(true);//Hypercare-050325-O
                    ...
                    //MergerchargeItem Old commented T52416-OS

                    // if MergeChargeItem_gBln then begin
                    //     if CustomInvoiceG then begin
                    //         SalesLineAmountincVat := Round(("Sales Line"."Quantity (Base)" * "Sales Line"."Customer Requested Unit Price") + (("Sales Line"."Quantity (Base)" * "Sales Line"."Customer Requested Unit Price") * "Sales Line"."VAT %" / 100), 0.01, '=') + FindAmountDiff_lFnc()
                    ...
                    //         Customeunitprice := "Sales Line"."Customer Requested Unit Price"
                    //     else
                    //         Customeunitprice := SalesLineAmountincVat / "Sales Line"."Quantity (Base)";
                    // end;
                    //end;

                    //MergerchargeItem Old commented T52416-OE
            ...
            begin
                ...
                if "Sales Header"."Exit Point" <> '' then begin
                    if ExitpointRec.Get("Sales Header"."Exit Point") then
                        PortOfLoding2 := ExitpointRec.Description; //port of loading mapping
                end;
    ...
    labels
    {
        ...
        TotalPayableinwords_Lbl = 'Total Amount: ';
    ...
    //         AmountDiff_lDec := Round((TotalFreight_lDec * "Sales Line"."Amount Including VAT") / TotalItemAmount_lDec, 0.01, '=');

    //     exit(AmountDiff_lDec);
    // end;
    //T52416-NE

    // local procedure FindUnitPrice_lFnc(): Decimal
    // var
    //     SL_lRec: Record "Sales Line";
    //     TotalFreight_lDec: Decimal;
    //     TotalItemAmount_lDec: Decimal;
    ...
    //     UnitPrice_lDec := AmountDiff_lDec / "Sales Line"."Quantity (Base)";
