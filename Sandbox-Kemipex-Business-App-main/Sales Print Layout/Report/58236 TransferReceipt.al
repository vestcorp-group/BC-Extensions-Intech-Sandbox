report 58236 "Transfer Receipt Report1"//T12370-Full Comment T13116-N
{
    // version Task4
    Caption = 'Transfer Receipt Report';
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/58236 Transfer Receipt Layout.rdl';
    ApplicationArea = All;
        ...
        dataitem("Transfer Receipt Header"; "Transfer Receipt Header")
        {
            ...
            dataitem("Transfer Receipt Line"; "Transfer Receipt Line")
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    column(QuantityBase_TL1; "Transfer Receipt Line"."Quantity (Base)") { }
                }
                ...
                begin
                    ...
                    if Item.Get("Transfer Receipt Line"."Item No.") then begin
                        ...
                        if "Transfer Receipt Line"."Variant Code" <> '' then begin
                            RecVariant.Get("Transfer Receipt Line"."Item No.", "Transfer Receipt Line"."Variant Code");
