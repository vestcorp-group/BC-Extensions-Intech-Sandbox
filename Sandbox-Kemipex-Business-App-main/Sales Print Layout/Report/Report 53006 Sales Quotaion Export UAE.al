report 53006 "Sales Quotaion Export UAE"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/Sales Quotation_Export.rdl';
    Caption = 'Sales Quotaion Export';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(PostingDate; UpperCase(Format("Order Date", 0, '<Day,2>-<Month Text,3>-<Year4>'))) { }
            ...
            column(PI_Validity_Date; UpperCase(Format("PI Validity Date", 0, '<Day,2>-<Month Text,3>-<Year4>')))
            { }
            //AW09032020<<
