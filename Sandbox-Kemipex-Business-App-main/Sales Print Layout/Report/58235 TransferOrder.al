report 58235 "Transfer Order Report1"//T12370-Full Comment
{
    // version Task4
    Caption = 'Transfer Order Report';
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/58235 Transfer Order Layout.rdl';
        ...
        dataitem("Transfer Header"; "Transfer Header")
        {
            ...
            dataitem("Transfer Line"; "Transfer Line")
            {
                ...
                begin
                    ...
                    /* Hypercare 03-02-2024 as per DN if "Variant Code" <> '' then begin
