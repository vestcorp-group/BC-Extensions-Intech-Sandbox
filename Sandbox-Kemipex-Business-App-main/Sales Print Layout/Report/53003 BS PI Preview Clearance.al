report 53003 "BS PI Preview Clearance"//T12370-Full Comment
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/53003 BS PI Preview Clearance.rdl';
    Caption = 'Pro Forma Invoice / BSO Clearance Report';
                    ...
                    If Item_LRec.GET("No.") THEN BEGIN
                        ...
                        if ItemUnitofMeasureL.FindFirst() then begin
                            ...
                            if "Sales Line"."Allow Loose Qty." then begin
                                PackingText := format(Result) + ' ' + UOMRec.Description + ' in Loose';
                            end else begin
                                ...
                                PackingText := format(Result) + ' ' + UOMRec.Description + ' of ' + PackingDescription;
                            end;
            ...
            begin
                ...
                if blnClrAddress then begin
                    ...
                    if SalesShiptoOption = SalesShiptoOption::"Default (Sell-to Address)" then begin
                        ...
                        //MS+
                        // if "Ship-to Code" <> '' THEN begin       //T13542-O
