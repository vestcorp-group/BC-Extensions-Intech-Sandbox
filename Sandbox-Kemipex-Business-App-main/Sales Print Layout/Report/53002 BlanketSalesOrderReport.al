report 53002 "Blanket Sales_PI Clearance"//T12370-Full Comment   //T12724
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/53002 BlanketSalesOrderReport Layout.rdl';
    Caption = 'Proforma/BSO-FZC';
