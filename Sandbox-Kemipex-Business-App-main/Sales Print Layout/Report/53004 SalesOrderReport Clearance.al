report 53004 "Sales PI Clearance"//T12370-Full Comment
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/53004 SalesOrderReport Clearance.rdl';
    Caption = 'Sales PI Clearance-FZC';
