...
report 53007 "KMP PostedSalesInv Clearance"//T12370-Full Comment
{
    //Stamp
    DefaultLayout = RDLC;
    RDLCLayout = 'Sales Print Layout/RDL/53007 KMP PostedSalesInv Clearance.rdl';
    Caption = 'Posted Sales Invoice Clr.';
