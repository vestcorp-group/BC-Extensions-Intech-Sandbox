page 53001 "Clearance Ship-to Address"//T12370-Full Comment //T12724
{
    Caption = 'Clearance Ship-to Address';
    DataCaptionExpression = Rec.Caption;
    PageType = Card;
    SourceTable = "Clearance Ship-to Address";
    ApplicationArea = All;
    ...
    local procedure OnAfterOnNewRecord(var Customer: Record Customer; var ShipToAddress: Record "Clearance Ship-to Address")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeOnNewRecord(var Customer: Record Customer; var IsHandled: Boolean; var ShipToAddress: Record "Clearance Ship-to Address")
    begin
    end;
}
