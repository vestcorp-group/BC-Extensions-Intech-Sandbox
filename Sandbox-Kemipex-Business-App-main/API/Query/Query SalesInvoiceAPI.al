// query 53015 SalesInvoicePostedWebAPI//T12370-Full Comment
// {
//     QueryType = Normal;

//     Caption = 'BI Sales Invoice Header'; // Bayas - IC Partner code required to added so we are using 53009 Page
