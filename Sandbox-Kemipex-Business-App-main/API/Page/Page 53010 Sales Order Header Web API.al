page 53010 "Sales Order Header Web API"//T12370-Full Comment //T50051 Code Uncommented
{
    ApplicationArea = All;
    Caption = 'BI Sales Order Header Web API';
    DataCaptionFields = "Document Type", "No.", "Sell-to Customer Name";
    PageType = List;
    ...
    begin
        ...
        GlSetup.get;
        OpenCLE.Reset();
        OpenCLE.SetRange("Document Type", Rec."Document Type"::Order);
