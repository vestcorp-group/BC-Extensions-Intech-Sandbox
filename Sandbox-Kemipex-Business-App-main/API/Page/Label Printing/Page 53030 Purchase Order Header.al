page 53030 APIPurchaseOrderHeader//T12370-Full Comment
{
    ApplicationArea = All;
    Caption = 'LP - API Purchase Order Header';
    PageType = API;
    ...
    EntityCaption = 'PurchaseOrderHeader';
    EntitySetCaption = 'PurchaseOrderHeaders';
