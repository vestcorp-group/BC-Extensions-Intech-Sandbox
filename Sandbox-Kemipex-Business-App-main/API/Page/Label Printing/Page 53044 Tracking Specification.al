// page 53044 APITrackingSpecification//T12370-Full Comment
// {
//     ApplicationArea = All;
//     Caption = 'LP - API Tracking Specification';
//     PageType = API;
//     SourceTable = "Tracking Specification";
//     Permissions = tabledata "Tracking Specification" = R;
...
//     EntityCaption = 'TrackingSpecification';
//     EntitySetCaption = 'TrackingSpecifications';
...
//                     ApplicationArea = all;
//                 }
//                 field("Transfer_Item_Entry_No"; rec."Transfer Item Entry No.")
//                 {
//                     ApplicationArea = all;
//                 }
...
//                     ApplicationArea = all;
//                 }
//                 field("Quantity_Handled_Base"; rec."Quantity Handled (Base)")
//                 {
//                     ApplicationArea = all;
//                 }
...
//                     ApplicationArea = all;
//                 }
//                 field("Qty_to_Handle"; rec."Qty. to Handle")
//                 {
//                     ApplicationArea = all;
//                 }
