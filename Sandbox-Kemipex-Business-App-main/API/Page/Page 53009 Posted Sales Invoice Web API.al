page 53009 "Posted Sales Invoice Web API"//T12370-Full Comment //T50051 Code Uncommented
{
    ApplicationArea = All;
    Caption = 'BI Posted Sales Invoice Header Web API';
    ...
    var
        OpenCLE: Record "Sales Invoice Header";
