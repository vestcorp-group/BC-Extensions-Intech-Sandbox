// page 53402 "KFZESales Budget Overview"//T12370-Full Comment
// {
...
//                 }
//             }
//             part(MATRIX; "KFZESales Budget Over. Matrix")
//             {
//                 ApplicationArea = SalesBudget;
//                 Editable = IsPageEditable;
//             }
...
//                     Enabled = CustomerFilterEnable;
//                     Editable = CustomerFilterEnable;
...
//                     ApplicationArea = SalesBudget;
//                     Caption = 'Item Filter';
//                     Enabled = ItemFilterEnable;
//                     Editable = ItemFilterEnable;
...
//                     end;
//                 }
//                 field(SalesTeamFilter; SalesTeamFilter)
//                 {
//                     ApplicationArea = all;
//                     Caption = 'Salesteam Filters';
//                     Enabled = SalesteamFileterEnable;
//                     Editable = SalesteamFileterEnable;
//                     trigger OnLookup(var Text: Text): Boolean
//                     begin
//                         Text := LookUpTeam();
//                         if Text > '' then
...
//                 {
//                     ApplicationArea = all;
//                     Enabled = SalespersonFilterEnable;
//                     Caption = 'Salesperson Filters';
//                     Editable = SalespersonFilterEnable;
//                     trigger OnLookup(var Text: Text): Boolean
//                     begin
//                         Text := LookUpSalesPerson();
//                         if Text > '' then
//                             exit(true);
//                     end;
...
//         SetNewBudgetName(ItemBudgetName2);
...
//         ItemBudgetName, ItemBudgetName2 : Record "Item Budget Name";
...
//         CustomerFilterEnable: Boolean;
//         ItemFilterEnable: Boolean;
//         SalesteamFileterEnable: Boolean;
//         SalespersonFilterEnable: Boolean;
...
//         CustomerFilterEnable := IsPageEditable or (UserSetup."Salespers./Purch. Code" = '');
//         ItemFilterEnable := IsPageEditable or (UserSetup."Salespers./Purch. Code" = '');
//         SalesteamFileterEnable := IsPageEditable or (UserSetup."Salespers./Purch. Code" = '');
//         SalespersonFilterEnable := IsPageEditable or (UserSetup."Salespers./Purch. Code" = '');
//     end;

//     procedure SetNewBudgetName(ItemBudgetName: Record "Item Budget Name")
//     begin
//         ItemBudgetName2 := ItemBudgetName;
//         NewBudgetName := ItemBudgetName.Name;
//         LineDimCode := ItemBudgetName."KFZEShow as Lines";
//         ColumnDimCode := ItemBudgetName."KFZEShow as Columns";
//         ValueType := ItemBudgetName."KFZEShow Value as";
//         RoundingFactor := ItemBudgetName."KFZERounding Factor";
//         DateFilter := GetDateFilter(ItemBudgetName."KFZE Year");
//     end;

//     local procedure GetDateFilter(Year: Integer): Text
//     var
...
//           GlobalDim1Filter, GlobalDim2Filter,
//           BudgetDim1Filter, BudgetDim2Filter, BudgetDim3Filter,
//           SalesPersonFilter, SalesTeamFilter);
...
//         IsPageEditable := UserSetup."KZFEEdit Allowed for Memb." or
//                                 (UserSetup."Salespers./Purch. Code" <> ''); // need to check
//     end;

//     local procedure SetSalesPersonFilters()
//     begin
//         Clear(SalesPersonFilter);
//         UserSetup.Get(UserId);
...
//     local procedure LookUpSalesPerson() ReturnText: text
//     var
//         _SalesPersonFilter: Text;
//         Salesperson: Record "Salesperson/Purchaser";
//         PageSalespersons: Page "Salespersons/Purchasers";
//     begin
//         Clear(ReturnText);
//         UserSetup.Get(UserId);
//         Salesperson.FilterGroup(2);
//         if UserSetup."Salespers./Purch. Code" > '' then begin
//             GetSalesPersonFilters(UserSetup, _SalesPersonFilter);
//             if _SalesPersonFilter > '' then
//                 Salesperson.SetFilter(Code, _SalesPersonFilter)
//             else
//                 Salesperson.SetRange(Code, UserSetup."Salespers./Purch. Code");
//             Salesperson.FilterGroup(0);

//         end;
//         PageSalespersons.LookupMode := true;
//         PageSalespersons.SetRecord(Salesperson);
//         PageSalespersons.SetTableView(Salesperson);
//         if PageSalespersons.RunModal() = Action::LookupOK then
//             ReturnText := PageSalespersons.GetSelectionFilter();
//     end;

//     local procedure LookUpTeam() ReturnText: text
//     var
//         TeamSalesperson: Record "Team Salesperson";
//         Team: Record Team;
//         PageSalesTeam: Page "Teams";
//         FilterSalesTeam: Text;
//     begin
//         Clear(ReturnText);
//         UserSetup.Get(UserId);
//         if UserSetup."Salespers./Purch. Code" > '' then begin
//             TeamSalesperson.FilterGroup(2);
//             TeamSalesperson.SetRange("Salesperson Code", UserSetup."Salespers./Purch. Code");
//             if TeamSalesperson.FindSet() then
//                 repeat
//                     if not FilterSalesTeam.Contains(TeamSalesperson."Team Code") then
//                         FilterSalesTeam += TeamSalesperson."Team Code" + '|';
//                 until TeamSalesperson.next = 0;
//         end;
//         if FilterSalesTeam > '' then begin
//             FilterSalesTeam := FilterSalesTeam.TrimEnd('|');
//             Team.FilterGroup(2);
//             Team.SetFilter(Code, FilterSalesTeam);
//             Team.FilterGroup(0);
//         end;


//         PageSalesTeam.LookupMode := true;
//         PageSalesTeam.SetRecord(Team);
//         PageSalesTeam.SetTableView(Team);
//         if PageSalesTeam.RunModal() = Action::LookupOK then
//             ReturnText := PageSalesTeam.GetSelectionFilter();
//     end;
// }
