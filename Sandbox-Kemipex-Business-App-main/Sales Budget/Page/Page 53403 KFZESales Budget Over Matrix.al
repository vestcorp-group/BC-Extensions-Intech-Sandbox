// page 53403 "KFZESales Budget Over. Matrix"//T12370-Full Comment
// {
...
//         ItemBudgetManagement: Codeunit "KFZEItem Budget Management";
...
//           ItemFilter, SourceTypeFilter, SourceNoFilter, DateFilter,
//           GlobalDim1Filter, GlobalDim2Filter, BudgetDim1Filter, BudgetDim2Filter, BudgetDim3Filter,
//           LineDimType, Rec, ColumnDimType, MATRIX_ColumnTempRec, NewAmount, SalesPersonFilter, SalesTeamFilter);
//     end;
...
//     procedure SetFilters(_DateFilter: Text; _ItemFilter: Text; _SourceNoFilter: Text; _GlobalDim1Filter: Text; _GlobalDim2Filter: Text; _BudgetDim1Filter: Text; _BudgetDim2Filter: Text; _BudgetDim3Filter: Text; _SalesPersonFilter: Text; _SalesTeamFilter: Text)
//     begin
...
//         SalesPersonFilter := _SalesPersonFilter;
//         SalesTeamFilter := _SalesTeamFilter;
//     end;
