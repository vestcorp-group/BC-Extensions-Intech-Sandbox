// codeunit 53401 "KFZEItem Budget Management"//T12370-Full Comment
// {
...
//                     Item.Setrange("KFZEShow on Sales Budget", true);
...
//     procedure SetBufferFilters(var ItemStatisticsBuf: Record "Item Statistics Buffer";
...
//                                     SalesTeamFilter: Text)
//     begin

//         ItemStatisticsBuf.Reset();
//         ItemStatisticsBuf.SetRange(ItemStatisticsBuf."Analysis Area Filter", ItemBudgetName."Analysis Area");
//         ItemStatisticsBuf.SetRange(ItemStatisticsBuf."Budget Filter", ItemBudgetName.Name);

//         if ItemFilter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Item Filter", ItemFilter);
//         if SourceNoFilter <> '' then begin
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Source Type Filter", '%1', SourceTypeFilter);
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Source No. Filter", SourceNoFilter);
//         end;
//         if DateFilter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Date Filter", DateFilter);
//         if GlobalDim1Filter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Global Dimension 1 Filter", GlobalDim1Filter);
//         if GlobalDim2Filter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Global Dimension 2 Filter", GlobalDim2Filter);
//         if BudgetDim1Filter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Dimension 1 Filter", BudgetDim1Filter);
//         if BudgetDim2Filter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Dimension 2 Filter", BudgetDim2Filter);
//         if BudgetDim3Filter <> '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."Dimension 3 Filter", BudgetDim3Filter);
//         if SalespersonFilter > '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."KFZESales Person Filter", SalespersonFilter);
//         if SalesTeamFilter > '' then
//             ItemStatisticsBuf.SetFilter(ItemStatisticsBuf."KFZESales Team Filter", SalesTeamFilter);
...
//     procedure DrillDownBudgetAmount(ItemBudgetName: Record "Item Budget Name";
//                                     ItemFilter: Text;
//                                     SourceTypeFilter: Enum "Analysis Source Type";
//                                     SourceNoFilter: Text;
//                                     DateFilter: Text;
...
//           GlobalDim1Filter, GlobalDim2Filter, BudgetDim1Filter, BudgetDim2Filter,
//           BudgetDim3Filter, SalespersonFilter, SalesTeamFilter);
...
//         if ItemStatisticsBuf.GetFilter("KFZESales Person Filter") <> '' then
//             ItemStatisticsBuf.CopyFilter("KFZESales Person Filter", ItemBudgetEntry."KFZESalesperson Code");
//         if ItemStatisticsBuf.GetFilter("KFZESales Team Filter") <> '' then
//             ItemStatisticsBuf.CopyFilter("KFZESales Team Filter", ItemBudgetEntry."KFZESales Team");
...
//     procedure CalculateAmount(ValueType: Enum "Item Analysis Value Type";
...
//                                 ColDimCodeBuf: Record "Dimension Code Buffer";
//                                 SalespersonFilter: Text;
//                                 SalesTeamFilter: Text): Decimal
//     begin
//         SetBufferFilters(
//           ItemStatisticsBuf, ItemBudgetName, ItemFilter, SourceTypeFilter, SourceNoFilter,
//           DateFilter, GlobalDim1Filter, GlobalDim2Filter, BudgetDim1Filter, BudgetDim2Filter,
//           BudgetDim3Filter, SalespersonFilter, SalesTeamFilter);
//         SetDimensionFilters(ItemStatisticsBuf, RowDimType, RowDimCodeBuf);
...
//             ValueType::"Sales Amount":
//                 begin
//                     ItemStatisticsBuf.CalcFields("KFZEBudgeted Sales Amount");
//                     exit(ItemStatisticsBuf."KFZEBudgeted Sales Amount");
//                 end;
//             ValueType::"Cost Amount":
//                 begin
//                     ItemStatisticsBuf.CalcFields("KFZEBudgeted Cost Amount");
//                     exit(ItemStatisticsBuf."KFZEBudgeted Cost Amount");
//                 end;
//             ValueType::Quantity:
//                 begin
//                     ItemStatisticsBuf.CalcFields("KFZEBudgeted Quantity");
//                     exit(ItemStatisticsBuf."KFZEBudgeted Quantity");
//                 end;
//         end;
//     end;

//     procedure SetAmount(ValueType: Enum "Item Analysis Value Type";
//                             SetColumnFilter: Boolean;
//                             var ItemStatisticsBuf: Record "Item Statistics Buffer";
//                             ItemBudgetName: Record "Item Budget Name";
//                             ItemFilter: Text;
...
//             ValueType::"Sales Amount":
//                 begin
//                     ItemStatisticsBuf.CalcFields("Budgeted Sales Amount", "KFZEBudgeted Sales Amount");
//                     ItemStatisticsBuf.Validate("Budgeted Sales Amount", NewAmount);
//                 end;
//             ValueType::"Cost Amount":
//                 begin
//                     ItemStatisticsBuf.CalcFields("Budgeted Cost Amount", "KFZEBudgeted Cost Amount");
//                     ItemStatisticsBuf.Validate("Budgeted Cost Amount", NewAmount);
//                 end;
//             ValueType::Quantity:
//                 begin
//                     ItemStatisticsBuf.CalcFields("Budgeted Quantity", "KFZEBudgeted Quantity");
//                     ItemStatisticsBuf.Validate("KFZEBudgeted Quantity", NewAmount);
//                 end;
//         end;
//     end;
