table 53000 "Clearance Ship-to Address"//T12370-Full Comment
{
    Caption = 'Clearance Ship-to Address';
    DataCaptionFields = "Customer No.", Name, "Code";
    LookupPageID = "Clearance Ship-to Address List";
    ...
    fields
    {
        ...
        field(30; "Shipment Method Code"; Code[50])
        {
            Caption = 'Shipment Method Code';
            TableRelation = "Shipment Method";
        }
        field(31; "Shipping Agent Code"; Code[50])
        {
        ...
        field(32; "Place of Export"; Code[50])
        {
        ...
        field(83; "Location Code"; Code[50])
        {
