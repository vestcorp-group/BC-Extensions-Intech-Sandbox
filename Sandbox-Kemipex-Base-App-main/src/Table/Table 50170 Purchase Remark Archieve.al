table 50170 "Purchase Remark Archieve"//T12370-N
{
    Caption = 'Remarks';
    ...
    var
        PurchaseRemarkLine: Record "Purchase Remark Archieve";
    ...
    var
        PurchaseRemarkSheet: Page "Purchase Remark Archieve Sheet";
    begin
        SetRange("Document Type", DocType);
        SetRange("No.", DocNo);
