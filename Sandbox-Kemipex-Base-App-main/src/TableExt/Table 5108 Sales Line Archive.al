tableextension 50331 KMP_ExtSalesLineArchieve extends "Sales Line Archive"//T12370-Full Comment //T-12855 Table Uncommented
{
    fields
    {
        field(50101; HSNCode; Code[20])
        {
            ...
            Caption = 'HSN Code';
            TableRelation = "Tariff Number"; //T-12855
        }
