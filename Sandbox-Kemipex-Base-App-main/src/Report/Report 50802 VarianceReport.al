report 50802 VarianceReport
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/VarianceReport.rdlc';
    Caption = 'VarianceReport';
    ...
    dataset
    {
        dataitem(IJLInt; Integer)
        {
            ...
            begin
                ...
                if ShowSample = false then if ItemJournalLineTmp."Inventory Posting Group" = 'SAMPLE' then CurrReport.Skip();
            end;
        }
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    {
                        Caption = 'Include Sample Items';
                        ApplicationArea = all;
                    }
                    // field(ShowOnlyVariance; ShowOnlyVariance)
                    // {
                    //     Caption = 'Show Only Variance';
                    //     ApplicationArea = all;
                    // }
                }
            }
