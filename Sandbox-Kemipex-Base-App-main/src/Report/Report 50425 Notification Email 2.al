// report 50425 "Notification Email 2"//T12370-Full Comment
// {
//     WordLayout = './Layouts/N NotificationEmail.docx';
...
//                     //     DocumentName := RecRef.Caption + ' ' + Format(RecRef.Field(50105));
//                     // end;
...
//             Database::"User Task":
//                 begin
//                     Field1Label := UserTaskRec.FieldCaption("Task Document No");
//                     FieldRef := RecRef.Field(UserTaskRec.FieldNo("Task Document No"));
//                     Field1Value := Format(FieldRef.Value);
//                     Field2Label := UserTaskRec.FieldCaption(Title);
//                     FieldRef := RecRef.Field(UserTaskRec.FieldNo(Title));
//                     Field2Value := Format(FieldRef.Value);
