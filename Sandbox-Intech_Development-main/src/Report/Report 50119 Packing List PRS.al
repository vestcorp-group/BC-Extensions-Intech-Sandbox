report 50119 "Packing List PRS"
{

    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/50119 PackingListPRS.rdl';
    Description = 'T49070';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Return Shipment Header")
        {
            ...
            column(OrderNo_SalesShipmentHeader; "Sales Shipment Header"."Return Order No.") { }
            ...
            column(Order_Date; FORMAT("Document Date", 0, '<Day,2> <Month Text> <Year4>')) { }
            column(LCNumber; '') { } //PackingListExtChange
            Column(LCDate; '') { } //PackingListExtChange
            ...
            dataitem("Sales Shipment Line"; "Return Shipment Line")
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    begin
                        if not SalesLineMerge then begin
                            ...
                            ShipmentLineRec.SetRange("Document No.", "Sales Shipment Line"."Document No.");
                            ShipmentLineRec.SetRange("No.", "Sales Shipment Line"."No.");
                            ShipmentLineRec.SetFilter("Line No.", '<%1', "Sales Shipment Line"."Line No.");
                            ShipmentLineRec.SetRange("Unit of Measure Code", "Sales Shipment Line"."Unit of Measure Code");
                            ShipmentLineRec.SetRange("Unit Price", "Sales Shipment Line"."Unit Price (LCY)");
                ...
                var
                    ...
                    ShipmentLineRec: Record "Return Shipment Line";
                    UOMRec: Record "Unit of Measure";
                    TemP: Decimal;
                ...
                begin
                    ...
                    if not SalesLineMerge then begin
                        ...
                        if ShipmentLineRec.FindFirst() then begin
                            repeat
                                if ("Unit Price (LCY)" = ShipmentLineRec."Unit Price (LCY)") and ("Unit of Measure Code" = ShipmentLineRec."Unit of Measure Code") then begin
                    ...
                    //HSNCode := "Sales Shipment Line".HSNCode; // hide by bayas - Item_LRec."Tariff No.";
                    ...
                    if PostedCustomInvoiceG then begin
                        ...
                        //UK::24062020>>
                        CountryRegRec.Reset();
                        if CountryRegRec.get("Sales Shipment Line"."Entry Point") then
                            Origitext := CountryRegRec.Name;
                        //AW09032020>>
                    ...
                    if "Sales Shipment Line"."Blanket Order No." <> '' then begin
                        ...
                        PINONew := "Sales Shipment Line"."Return Order No.";
                        salesHeader.Reset();
                        salesHeader.SetRange("Document Type", salesHeader."Document Type"::Order);
                        salesHeader.SetRange("No.", "Sales Shipment Line"."Return Order No.");
                        if salesHeader.FindFirst() then
                            PIDATENew := salesHeader."Order Date"
                        else begin
                            salesHeaderArchive.Reset();
                            salesHeaderArchive.SetRange("Document Type", salesHeaderArchive."Document Type"::Order);
                            salesHeaderArchive.SetRange("No.", "Sales Shipment Line"."Return Order No.");
                            if salesHeaderArchive.FindFirst() then
                                PIDateNew := salesHeaderArchive."Order Date";
                        end;
                    end;
            ...
            {
                DataItemLink = "Document No." = field("Return Order No.");
            ...
            begin
                ...
                Clear(CustAddr_Arr);
                FormatAddr.PurchShptBuyFrom(CustAddr_Arr, "Sales Shipment Header");
                ...
                //AW
                SalesHeaderRec.Reset();
                if SalesHeaderRec.Get(SalesHeaderRec."Document Type"::Order, "Return Order No.") then
