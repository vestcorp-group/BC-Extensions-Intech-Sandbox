Report 85203 "GL Posting Date Update" //T13883-N 270225
{
    //T11452 - NEw Report
    ...
    dataset
    {
        dataitem("General Ledger Setup"; "General Ledger Setup")
        {
            ...
            begin
                ...
                "General Ledger Setup"."Allow Posting From" := AllowPostingFrom_lDte;
                "General Ledger Setup"."Allow Posting To" := AllowPostingTo_lDte;
            ...
            begin
                "General Ledger Setup".SetFilter("Posting Restriction", '<>%1', '');
