report 50104 "Aged Accounts Receivable New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/AgedAccountsReceivable_New.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable Customized';
    ...
    var
        ...
        TotalCustLedgEntry: array[9] of Record "Cust. Ledger Entry";
        GrandTotalCustLedgEntry: array[9] of Record "Cust. Ledger Entry";
        ...
        CompanyDisplayName, OverduedStyle_gTxt, VendorPostingGroup_gTxt : Text;
