report 50125 "Aged Accounts Payable PeriodWi"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/AgedAccountsPayablePeriodWise.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Payable PeriodWise';
            ...
            dataitem(Vendor; Vendor)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempVendortLedgEntryLoop; "Integer")
                    {
                        ...
                        column(AgedVendLedgEnt15RemAmtLCY; AgedVendorLedgEntry[15]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(AgedVendLedgEnt16RemAmtLCY; AgedVendorLedgEntry[16]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        column(AgedVendLedgEnt15RemAmt; AgedVendorLedgEntry[15]."Remaining Amount")
                        {
                            AutoFormatExpression = CurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(AgedVendLedgEnt16RemAmt; AgedVendorLedgEntry[16]."Remaining Amount")
                        {
                            AutoFormatExpression = CurrencyCode;
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            ...
                            if CurrExchRate_lRec.FindLast() then begin
                                AgedVendorLedgEntry[PeriodIndex]."Remaining Amount" := 1 / CurrExchRate_lRec."Relational Exch. Rate Amount" * VendorLedgEntryEndingDate."Remaining Amt. (LCY)";
                            end;
    ...
    var
        ...
        TotalVendorLedgEntry: array[16] of Record "Vendor Ledger Entry";
        AgedVendorLedgEntry: array[16] of Record "Vendor Ledger Entry";
        TempCurrency: Record Currency temporary;
        TempCurrency2: Record Currency temporary;
        TempCurrencyAmount: Record "Currency Amount" temporary;
        DetailedVendorLedgerEntry: Record "Detailed Vendor Ledg. Entry";
        PeriodLength: DateFormula;
        GrandTotalVLERemaingAmtLCY: array[16] of Decimal;
        GrandTotalVLEAmtLCY: Decimal;
        PrintAmountInLCY: Boolean;
        StartingDt, EndingDate, PostingDate_gDte : Date;
