tableextension 50201 ProdForecastEntryExt50201 extends "Production Forecast Entry"
{
    fields
    {
        //T51238-NS
        ...
        field(50006; "Customer Code"; Code[20])
        {
            ...
            begin
                customer_lRec.Reset();
                If customer_lRec.GET("Customer Code") then
                    Rec."Customer Name" := customer_lRec.Name;
            end;
        }
        field(50007; "Customer Name"; Text[100])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
