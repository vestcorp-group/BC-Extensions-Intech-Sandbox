codeunit 50018 "Match Bank Rec. Lines_SA"
{

    //Save as Codeunit 1252  //T12141
    trigger OnRun()
    begin
    end;
    ...
    var
        ...
        AmountClose: Boolean;
        BankTransMatched: Boolean;//T12141-N
    ...
    begin
        ...
        if BankAccountLedgerEntry.Get(TempBankAccLedgerEntryMatchingBuffer."Entry No.") then;//T12141-N
        ...
        if BankAccountLedgerEntry."Bank Transaction No." <> '' then
            BankTransMatched := (BankAccReconciliationLine."Bank Transaction No." = BankAccountLedgerEntry."Bank Transaction No.");//T12141-N
        ...
        // exit(((DocumentNoMatched or ExternalDocumentNoMatched or DescriptionMatched) and AmountClose) or AmountMatched);//T12141-O
        exit(((DocumentNoMatched or ExternalDocumentNoMatched or DescriptionMatched) and AmountClose) or AmountMatched or BankTransMatched);//T12141-N
    end;
    ...
    begin
        ...
        if TempBankStatementMatchingBuffer.FindSet() then
            repeat
                ...
                IF BankAccountLedgerEntry."Bank Transaction No." = BankAccReconciliationLine."Bank Transaction No." then begin  //T12141-N 01-07-24
    ...
    var
        ...
        BankAccEntrySetReconNo: Codeunit "Bank Acc. Entry SetRecon-No_SA";
