codeunit 50036 "Sibscribe Table 124"
{
    //T12539-NS
    [EventSubscriber(ObjectType::Table, Database::"Purch. Cr. Memo Hdr.", 'OnAfterDeleteEvent', '', false, false)]
    local procedure PurchaseHeader_OnAfterDeletEvent(var Rec: Record "Purch. Cr. Memo Hdr.")
    var
    ...
    begin
        ...
        PostedMultiplePmtTerms_lRec.SetRange("Document Type", PostedMultiplePmtTerms_lRec."Document Type"::"Posted Purchase Cr. Memo");
