report 50500 "Certificate of Analysis"
{
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                {
                    DataItemLink = "Source ID" = field("Document No."), "Source Ref. No." = field("Document Line No."), "Item No." = field("Item No."), "Lot No." = field(CustomLotNumber), "BOE No." = field(CustomBOENumber);
            ...
            begin
                ...
                FooterTextG := CompInfoG.name + ', ' + CompInfoG.Address + ', ' + CompInfoG."Address 2" + ' Tel:' + CompInfoG."Phone No." + ' Fax:' + CompInfoG."Fax No.";//T45559-N
