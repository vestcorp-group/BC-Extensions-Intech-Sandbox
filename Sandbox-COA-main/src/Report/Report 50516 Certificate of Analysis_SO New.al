report 50516 "Certificate of Analysis_SO New"
{
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Reservation Entry"; "Reservation Entry")
            {
                ...
                DataItemTableView = sorting("Source Ref. No.") where("Source Type" = const(37), Quantity = filter(< 0), "Source Subtype" = const(1));
                ...
                dataitem("Lot Variant Testing Parameter"; "Lot Variant Testing Parameter")
                {
                    DataItemLink = "Source ID" = field("Source ID"), "Source Ref. No." = field("Source Ref. No."), "Item No." = field("Item No."), "Variant Code" = field("Variant Code"), "Lot No." = field(CustomLotNumber), "BOE No." = field(CustomBOENumber);
                ...
                begin
                    ...
                    RecSalesLine.SetRange("Line No.", "Reservation Entry"."Source Ref. No.");
