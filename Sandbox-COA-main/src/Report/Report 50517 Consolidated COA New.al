report 50517 "Consolidated COA New"
{
    ApplicationArea = All;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                var
                    ...
                    RecLotTestingParameter: Record "Lot Variant Testing Parameter"; //AJAY
                ...
                begin
                    ...
                    if ReservationEntry.FindSet() then begin
                        ...
                        MakeExcelDataHeader("Line No.", "Variant Code", ReservationEntry.CustomLotNumber, ReservationEntry.CustomBOENumber);
                        repeat
    ...
    local procedure MakeExcelDataHeader(LineNumber: Integer; VariantCode: Code[20]; LotNumber: Code[50]; BOE: Text[20])
    var
    ...
    begin
        ...
        if RecLine.FindSet() then begin
            repeat
                ...
                ReservationEntry.SetRange("Variant Code", RecLine."Variant Code");
                ReservationEntry.SetFilter(Quantity, '<0');
                ReservationEntry.SetRange("Source Subtype", 1);
                ...
                LotVariantTestingParameter.SetCurrentKey(Priority);
                LotVariantTestingParameter.SetAscending(Priority, true);
                LotVariantTestingParameter.SetRange("Item No.", RecLine."No.");
                LotVariantTestingParameter.SetRange("Variant Code", RecLine."Variant Code");
                LotVariantTestingParameter.SetRange("Source ID", "Sales Header"."No.");
                LotVariantTestingParameter.SetRange("Lot No.", ReservationEntry.CustomLotNumber);
                LotVariantTestingParameter.SetRange("Source Ref. No.", LineNumber);
                LotVariantTestingParameter.SetRange("BOE No.", ReservationEntry.CustomBOENumber);
                LotVariantTestingParameter.SetRange("Show in COA", true);
                if LotVariantTestingParameter.FindSet() then begin
                    repeat
                        ParameterCount += 1;
                        LotVariantTestingParameter.CalcFields("Testing Parameter Code");
                        ...
                        ExcelBuf.AddColumn(LotVariantTestingParameter."Testing Parameter" + Format(char1) + Format(char2) + LotVariantTestingParameter."Testing Parameter Code", FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
                        IF LotVariantTestingParameter."Variant Code" = '' THEN begin
                            Clear(ItemTestingParameter);
                            ItemTestingParameter.SetRange("Item No.", LotVariantTestingParameter."Item No.");
                            ItemTestingParameter.SetRange(Code, LotVariantTestingParameter.Code);
                            if ItemTestingParameter.FindFirst() then begin
                                if ItemTestingParameter."Data Type" = ItemTestingParameter."Data Type"::Alphanumeric then begin
                                    ExcelBuf.AddColumn('', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
                        ...
                        END ELSE begin
                            Clear(ItemVariantTestingParameter);
                            ItemVariantTestingParameter.SetRange("Item No.", LotVariantTestingParameter."Item No.");
                            ItemVariantTestingParameter.SetRange("Variant Code", LotVariantTestingParameter."Variant Code");
                            ItemVariantTestingParameter.SetRange(Code, LotVariantTestingParameter.Code);
                            if ItemVariantTestingParameter.FindFirst() then begin
                                if ItemVariantTestingParameter."Data Type" = ItemVariantTestingParameter."Data Type"::Alphanumeric then begin
                                    ExcelBuf.AddColumn('', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
                                    RowNumber.Add(ParameterCount);
