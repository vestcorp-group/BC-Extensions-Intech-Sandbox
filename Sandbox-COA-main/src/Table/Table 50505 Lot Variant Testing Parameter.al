table 50505 "Lot Variant Testing Parameter"
{
    DataClassification = CustomerContent;
    Caption = 'Lot Variant Testing Parameter';
    ...
    fields
    {
        ...
        field(6; Code; Code[20])
        {
            ...
            // TableRelation = "Item Variant Testing Parameter"."Code" where("Item No." = field("Item No."), "Variant Code" = field("Variant Code")); //new Code added
            // trigger OnValidate()
            // var
            //     //ItemTestingParameterL: Record "Item Testing Parameter"; //New Code added
            //     ItemVariantTestingParameter: Record "Item Variant Testing Parameter"; //New Code added
            // begin
        ...
        field(31; Priority; Integer)
        {
            ...
            trigger OnValidate()
            var
                ItemTestingParameterL: Record "Item Variant Testing Parameter";
                PriorityDuplicateErr: Label 'Priority can''t be duplicated.';
            begin
                ItemTestingParameterL.SetRange("Item No.", "Item No.");
                ItemTestingParameterL.SetRange("Variant Code", "Variant Code");
                ...
                if Type = Type::Range then begin
                    if ("Vendor COA Value Result" <> 0) then begin
                        if ("Vendor COA Value Result" < "Minimum") or ("Vendor COA Value Result" > "Maximum") then begin
                            if not SICduQCCOA_lCdu.getProcess_gFnc() then begin//Mayank-Anoop
