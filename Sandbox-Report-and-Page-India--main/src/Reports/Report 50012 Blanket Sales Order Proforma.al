report 50012 "Blanket Sales Order - Proforma"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Proforma Invoice_Local.rdl';
    Caption = 'Blanket Sales Order - Proforma Turkish';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(No; "No.") { }
            column(ExchangeRate1; (1 / "Currency Factor"))
            {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(OTVAmount_lDec; OTVAmount_gDec)
                {
                }
                ...
                begin
                    ...
                    //     TotalOTVAmount_lDec += OTVAmount_gDec;
                    // end;
                end;
            ...
            begin
                ...
                if SalesLine_Lrec.FindSet(false) then
                    repeat
                        ...
                        TaxTransactionValue.SetFilter(Amount, '<>%1', 0);
                        if TaxTransactionValue.Findfirst() then
                            TotalVatAmount_gDec += TaxTransactionValue.Amount;
                    until SalesLine_Lrec.Next = 0;

                TotalAmt := Round(TotalAmt, 0.01) + TotalOTVAmount_lDec + TotalVatAmount_gDec;//SD::GK 5/25/2020
