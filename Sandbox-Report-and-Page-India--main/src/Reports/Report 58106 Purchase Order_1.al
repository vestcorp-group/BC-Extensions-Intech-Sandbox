report 58106 "Purchase Order_1"//T12370-N
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Comp_GSTRegNo; CompanyInformation."GST Registration No.") { }
            ...
            column(Comp_VatRegNo; CompanyInformation."Registration No.") { }
            ...
            column(PostingDate_; "Document Date") { }
            ...
            column(TotalAmountAED; TotalAmountINR) { }
