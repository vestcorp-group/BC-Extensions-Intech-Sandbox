report 54789 "Sales Shipment Rep. New4"//T12370-N
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            column(PostingDate_SalesShipmentHeader; Format("Sales Shipment Header"."Posting Date", 0, '<Day,2>/<Month,2>/<Year4>')) { }
            ...
            column(CustomerRecBillPan; CustomerRecBill."P.A.N. No.")
            {

            }
            column(CustomerRecBillGST; CustomerRecBill."GST Registration No.")
            {

            }
            column(CustomerRecBillName; CustomerRecBill.Name)
            {

            }
            column(CustomerRecBilladress; CustomerRecBill.Address)
            {

            }
            column(CustomerRecBilladress2; CustomerRecBill."Address 2")
            {

            }
            column(CustomerRecBillCity; CustomerRecBill.City)
            {

            }
            column(CustomerRecBillContry; ContrrecBillCustomer.Name)
            {

            }

            column(CustomerRecBillPhone; CustomerRecBill."Phone No.")
            {

            }
            column(CustomerRecBillPincode; CustomerRecBill."Post Code")
            {

            }
            column(CustomerRecSillPan; CustomerRecSill."P.A.N. No.")
            {

            }
            column(CustomerRecSillGST; CustomerRecSill."GST Registration No.")
            {

            }

            column(CustomerRecSillName; CustomerRecSill.Name)
            {

            }
            column(CustomerRecSilladress; CustomerRecSill.Address)
            {

            }
            column(CustomerRecSilladress2; CustomerRecSill."Address 2")
            {

            }
            column(CustomerRecSillCity; CustomerRecSill.City)
            {

            }
            column(CustomerRecSillContry; ContrrecSillCustomer.Name)
            {

            }
            column(CustomerRecSillPhone; CustomerRecSill."Phone No.")
            {

            }
            column(CustomerRecSillpincode; CustomerRecSill."Post Code")
            {
            ...
            Column(LCDate; "Sales Shipment Header"."LC Date 2") { } //PackingListExtChange
                        ...
                        if ItemUnitofMeasureL.FindFirst() then begin
                            ...
                            if "Variant Code" <> '' then begin // add by bayas
                                ...
                                if VariantRec."Packing Description" <> '' then begin
                                    PackingTxt := format(Quantity) + ' ' + "Unit of Measure Code" + ' of ' + VariantRec."Packing Description";
                                end else begin
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                begin
                    ...
                    // SKM 
                    IF ILQty <> 0 THEN begin
                        I := i + 1;
                        QtyNew := QtyNew + ILQty;
                        IF I = 1 THEN BEGIN
                            Pakingmark := '1' + '-' + FORMAT(ILQty);
                            StartQty := ILQty + 1;

                        END ELSE BEGIN
                            Pakingmark := Format(StartQty) + '-' + FORMAT(QtyNew);
                            StartQty += ILQty + 1;
            ...
            begin
                ...
                if CustomerRecSill.get("Sell-to Customer No.") then;
                if ContrrecBillCustomer.get(CustomerRecBill."Country/Region Code") then;
                if CustomerRecSill.get(CustomerRecSill."Country/Region Code") then;


                if ContrrecComapny.get(CompanyInformation."Country/Region Code") then;
                ExitPt.Reset();
                IF ExitPt.Get("Sales Shipment Header"."Exit Point") then
    ...
    var
        ...
        CustAddr_Arr: array[9] of Text;
        CustAddrShipTo_Arr: array[8] of Text;
        ContrrecBillCustomer: Record "Country/Region";
        ContrrecSillCustomer: Record "Country/Region";
        ...
        CustomerRecSill: Record Customer;
        ShiptoVar: Boolean;
        ILQty: Decimal;
        SalesUOM: Text[50];
        SalesQty: Decimal;
        ...
        CustAltAddr_Arr: array[8] of Text;
