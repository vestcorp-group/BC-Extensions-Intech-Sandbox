report 50008 JournalVoucher
{
    ...
    dataset
    {
        dataitem(GLEntry; "G/L Entry")
        {
            ...
            begin
                ...
                Reporttitle_gTxt := 'Journal Voucher';

                // If GLEntry."Source Code" = 'JournalJNL' then
                //     Reporttitle_gTxt := 'Journal Voucher'
                // else
                //     if GLEntry."Source Code" = 'CASHRECJNL' then
                //         Reporttitle_gTxt := 'Receipt Voucher';

                // if (GLEntry."Source Code" <> 'JournalJNL') AND (GLEntry."Source Code" <> 'CASHRECJNL') then
                //     CurrReport.Skip();
                ...
                //     VendorLedgerEntry_gRec.SetRange("Document Type", "Document Type"::Journal);
                ...
                //         CustomerLedgerEntry_gRec.SetRange("Document Type", "Document Type"::Journal);
    ...
    labels
    {
        Reporttitle_lbl = 'Journal Voucher';
