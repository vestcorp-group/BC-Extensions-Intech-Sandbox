...
//             dataitem("Merge_Sales Invoice Line"; "Sales Invoice Line")
//             {
//                 DataItemTableView = WHERE(Type = filter(> " "));
//                 DataItemLinkReference = "Sales Invoice Header";
//                 DataItemLink = "Document No." = FIELD("No.");
//                 column(MergeSrNo; SrNo)
//                 {
//                 }

//                 column(MergeLineNo_SalesInvoiceLine; "Line No.")
//                 {
//                 }
//                 column(MergeNo_SalesInvoiceLine; "No.")
//                 {
//                     IncludeCaption = true;
//                 }
//                 column(MergeIsItem; IsItem)
//                 { }
//                 column(MergeGST_Group_Code; "GST Group Code")
//                 {

//                 }

//                 column(MergeDescription_SalesInvoiceLine; Description)
//                 {
//                     IncludeCaption = true;
//                 }
//                 column(MergeQuantity_SalesInvoiceLine; "Quantity (Base)")
//                 {
//                     IncludeCaption = true;
//                 }
//                 column(MergeUnitofMeasureCode_SalesInvoiceLine; "Base UOM 2") //PackingListExtChange
//                 {
//                 }
//                 column(MergeUnitPrice_SalesInvoiceLine; Customeunitprice)
//                 {
//                     // IncludeCaption = true;
//                 }
//                 column(MergeVatPer; "VAT %")
//                 {
//                     // IncludeCaption = true;
//                 }
//                 column(MergeVatAmt; SalesLineVatBaseAmount * "VAT %" / 100)
//                 {
//                 }
//                 column(MergeAmountIncludingVAT_SalesInvoiceLine; SalesLineAmountincVat)
//                 {
//                     // IncludeCaption = true;
//                 }
//                 column(MergeSearchDesc; SearchDesc)
//                 {
//                 }
//                 column(MergeOrigin; Origitext)
//                 {
//                 }
//                 column(MergeHSCode; HSNCode)
//                 {
//                 }
//                 column(MergePacking; Packing_Txt)
//                 {
//                 }

//                 column(MergeLine_No_; "Line No.") { }
//                 column(MergeTaxable_gDec; MergeTaxable_gDec) { }
//                 column(MergeQty_gDec; MergeQty_gDec) { }
//                 column(MergeSGST_gDec; MergeSGST_gDec) { }
//                 column(MergeCGST_gDec; MergeCGST_gDec) { }
//                 column(MergeAmtIncl_gDec; MergeAmtIncl_gDec) { }
//                 column(ItemNo_gCod; ItemNo_gCod) { }
//                 column(MergeLineHSNCodeText; LineHSNCodeText)
//                 { }
//                 column(MergeLineCountryOfOriginText; LineCountryOfOriginText)
//                 { }
//                 column(MergeSorting_No_; SortingNo)
//                 { }
//                 column(MergeSrNo3; SrNo3) { }
//                 column(MergeSrNo4; SrNo4) { }
//                 column(MergeSrNo5; SrNo5) { }
//                 column(MergePINONew; PINONew) { }
//                 column(MergeOrderNo; OrderNo)
//                 {

//                 }
//                 column(MergeSTPer; STPer)
//                 {

//                 }
//                 column(MergeCTPer; CTPer)
//                 {

//                 }
//                 column(mergeITPer; ITPer)
//                 {

//                 }
//                 column(MergeAMountInW; AMountInW + ' ' + Notext[2])
//                 {

//                 }
//                 column(MergeTotalValue; TotalValue)
//                 {

//                 }
//                 column(MergeTotalSgstamt; TotalSgstamt)
//                 {

//                 }
//                 column(MergeTotalCgstamt; TotalCgstamt)
//                 {

//                 }
//                 column(MergeTotalIgstamt; TotalIgstamt)
//                 {

//                 }
//                 column(MergeLine_Amount; "Line Amount")
//                 {

//                 }
//                 column(MergeAmount; Amount_gDec) { }

//                 column(MergePIDateNew; PIDateNew) { }
//                 column(MergeVatOOS; VatOOS) { }
//                 trigger OnPreDataItem()
//                 var
//                     myInt: Integer;
//                 begin
...
//                 begin
//                     if ItemNo_gCod <> "Merge_Sales Invoice Line"."No." then begin
//                         //New SrNo
//                         SrNo += 1;
//                         SIL_lRec.Reset();
//                         SIL_lRec.SetRange("Document No.", "Merge_Sales Invoice Line"."Document No.");
//                         SIL_lRec.SetRange("No.", "Merge_Sales Invoice Line"."No.");
//                         if SIL_lRec.FindSet() then begin
//                             repeat
//                                 MergeQty_gDec += SIL_lRec.Quantity;
//                                 if ("Merge_Sales Invoice Line".Quantity * "Merge_Sales Invoice Line"."Unit Price") <> 0 then
//                                     MergeTaxable_gDec += "Merge_Sales Invoice Line".Quantity * "Merge_Sales Invoice Line"."Unit Price"
//                                 else
//                                     MergeTaxable_gDec += "Merge_Sales Invoice Line".Amount;
...
//                                         IF GSTledgerentry."GST Component Code" = 'SGST' THEN begin
//                                             STPer := GSTledgerentry."GST %";
//                                             MergeSGST_gDec += ABS(GSTledgerentry."GST Amount");
//                                         end;

//                                         IF GSTledgerentry."GST Component Code" = 'CGST' THEN begin
//                                             CTPer := GSTledgerentry."GST %";
//                                             MergeCGST_gDec += ABS(GSTledgerentry."GST Amount");
//                                         end;
...
//                                 MergeAmtIncl_gDec += MergeTaxable_gDec + MergeSGST_gDec + MergeCGST_gDec;
//                             until SIL_lRec.Next() = 0;
//                         end;
//                         CurrReport.Skip();
//                     end;
//                     ItemNo_gCod := "Merge_Sales Invoice Line"."No.";
//                 end;
...
//     var
//         MergeQty_gDec: Decimal;
//         MergeTaxable_gDec: Decimal;
//         MergeCGST_gDec: Decimal;
//         MergeSGST_gDec: Decimal;
//         MergeAmtIncl_gDec: Decimal;
//         ItemNo_gCod: Code[20];
//         Amount_gDec: Decimal;
