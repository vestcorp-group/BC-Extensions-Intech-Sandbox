report 54785 "Sales Order New"//T12370-Full Comment
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Layout_80003_OrderConfirmationSalesOrderReport.rdl';
    Caption = 'Order Confirmation Report-CPI';
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(GSTValue_Bln; CompanyInformation."Enable GST caption") { }
