//Add the report link in "Report Selection - Purchase"...original id is 408
report 50320 "Custom Purchase-Receipt"//T12370-N
{
    // version NAVW113.00
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Custom Purchase - Receipt New.rdl';
    Caption = 'PurchaseReceipt';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(CompCity; CompanyInfo.City + ', ' + contryName.Name)
            {

            }
            column(CompanyInRegNew; CompanyInfo."Registration No New")
            {
            ...
            column(vendorGST; vendorInfo."GST Registration No.") { }
            column(vendorPANNo; vendorInfo."P.A.N. No.") { }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        //  column(Packing; Item."Description 2"){} // hide by bayas
                        column(Packing; PackingText) { } // added by bayas
                        /* column(Origin_; Item."Country/Region of Origin Code")
                        { } */
                        column(Origin_; Origitext)
                        { }
                        column(HS_Code_; "Item HS Code")
                        { }
                        ...
                        begin
                            ...
                            if "Variant Code" <> '' then begin // add by bayas
                                ...
                                if VariantRec."Packing Description" <> '' then begin
                                    ...
                                    PackingText := Item."Description 2";
                                end;
                            end else begin
                                PackingText := Item."Description 2";
                            end;
            ...
            begin
                ...
                if CountryG.Get("Pay-to Country/Region Code") then
                    ...
                    countrydesc := '';
                vendorInfo.get("Buy-from Vendor No.");

                FormatAddressFields("Purch. Rcpt. Header");
                FormatDocumentFields("Purch. Rcpt. Header");
                contryName.Get(CompanyInfo."Country/Region Code");
    ...
    var
        ...
        //T12370-N EventSubscriberUnitG: Codeunit KMP_EventSubscriberUnit;
        Continue: Boolean;
        ...
        GSTRegNoCaptionLbl: Label 'GST Registration No.';
        ...
        if ItemUoML.FindSet() then
            repeat
                ...
                if not UnitofMeasureL."Decimal Allowed" then
                    if ItemUoML."Net Weight" <> 0 then
                        GrossWeightP += (NetWeightP / ItemUoML."Net Weight") * ItemUoML."Packing Weight"; //SKK
                                                                                                          //GrossWeightP += (NetWeightP / ItemUoML."Net Weight") * ItemUoML."Packing Weight"; //SKK
