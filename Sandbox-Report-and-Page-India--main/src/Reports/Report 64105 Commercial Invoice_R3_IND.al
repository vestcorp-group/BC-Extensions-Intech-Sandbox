...
report 64105 "Commercial Invoice_R3_IND"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Commercial Invoice_R3_IND.rdl';
                ...
                begin
                            ...
                            repeat
                                ...
                                if ("Unit Price" = SalesLineL."Unit Price") and ("Unit of Measure Code" = SalesLineL."Unit of Measure Code") then begin
                                    if PostedCustomInvoiceG then begin
                                        ...
                                        // else
                                        SalesLineAmountincVat += SalesLineAmount + (SalesLineAmount * "VAT %" / 100) + GstAmount_gDec;
                    ...
                    if MergeChargeItem_gBln then begin
                        if PostedCustomInvoiceG then begin
                            ...
                            SalesLineAmountincVat := Round(("Sales Invoice Line"."Quantity (Base)" * "Sales Invoice Line"."Customer Requested Unit Price") + (("Sales Invoice Line"."Quantity (Base)" * "Sales Invoice Line"."Customer Requested Unit Price") * "Sales Invoice Line"."VAT %" / 100), 0.01, '=');
                            ...
                            SalesLineAmountincVat := SalesLineAmountincVat;
