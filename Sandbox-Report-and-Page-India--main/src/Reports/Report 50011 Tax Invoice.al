...
report 50011 "Tax Invoice_Turkish"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Tax Invoice Turkey.rdl';
    Caption = 'Tax Invoice Turkey';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                column(OTVAmount_lDec; OTVAmount_lDec)
                {
                }
                ...
                begin
                    ...
                    if TaxTransactionValue.Findfirst() then
                        OTVAmount_lDec := TaxTransactionValue.Amount;
                    ...
                    TotalOTVAmount_lDec += OTVAmount_lDec;
                    TotalVATAmount_lDec += VATAmount_gDec;
