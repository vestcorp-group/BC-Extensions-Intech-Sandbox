report 64101 "Export_Invoice"//T12370-Full Comment
{
    UsageCategory = Administration;
    ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Export_Invoice.rdl';
    Caption = 'Export_Invoice';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(CompanyInformationGST; 'GSTN No.: ' + CompanyInformation."GST Registration No.")
            {
            ...
            column(LUTARNNO; CompanyInformation."LUT ARN No")
            {
            ...
            column(CompanyInformationpostcode; 'Pin Code-' + CompanyInformation."Post Code")
            {
            ...
            begin
                ...
                Clear(QRCode);
                Clear(Instr);
                //Commented need to map new intech add on mapping
                CalcFields("QR Code");
                ...
                If "Currency Factor" <> 0 then begin
                    ...
                    ExchangeRate := StrSubstNo('%1', Round((1 / "Currency Factor"), 0.001));
