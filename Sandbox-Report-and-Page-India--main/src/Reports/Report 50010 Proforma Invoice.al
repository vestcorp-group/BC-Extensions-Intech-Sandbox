report 50010 "Standard Sales - Pro FormaInv."
{
    Caption = 'Pro Forma Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/StandardSalesProFormaInv.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(ExchangeRate; (1 / "Currency Factor"))
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    TaxTransactionValue.SetRange("Tax Record ID", Line.RecordId);
                    ...
                    if Quantity <> 0 then begin
                        ...
                        TotalVAT_gDec += VATAmount_gDec;
                        TotalAmountInclVAT += Round("Amount Including VAT", Currency."Amount Rounding Precision") + TotalOTVAmount_lDec + TotalVAT_gDec;
                    end;
                end;
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalOTVAmount; FormattedTotalOTVAmount)
                {
                ...
                begin
                    ...
                    FormattedTotalVATAmount := Format(TotalVAT_gDec, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::AmountFormat, CurrencyCode));
                    ...
                    FormattedTotalOTVAmount := format(TotalOTVAmount_lDec, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::AmountFormat, CurrencyCode))
                end;
            }
