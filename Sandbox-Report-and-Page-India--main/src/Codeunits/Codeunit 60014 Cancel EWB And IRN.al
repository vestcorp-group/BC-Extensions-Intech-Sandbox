// codeunit 60014 "Cancel EWB And IRN"//T12370-N
// {
...
//         SCrMemoHdr.TestField("Transport Method");
//         // SCrMemoHdr.TestField("Transporter ID");
//         // SCrMemoHdr.TestField("Transporter Name");
//         Clear(IsSuccess);
//         Clear(ResponseText);
//         Clear(IrisAPI);
//         Clear(Token);
...
//         IrisAPI.GetResponse(IsSuccess, ResponseText);
//         if IsSuccess then
//             StoreIrisResponse(ResponseText, SCrMemoHdr)
//         else
//             Error(ResponseText);
//     end;

//     procedure CreateJSONForIRIS(var SIHdr: Record "Sales Cr.Memo Header"; Isdemocall: Boolean): Text
//     var
...
//         RecLines: Record "Sales Cr.Memo Line";
//         JsonText: Text;
...
//         CalcStatistics.GetPostedSalesCrMemoStatisticsAmount(SIHdr, TotalInclTaxAmount);
...
//     local procedure StoreIrisResponse(ResponseText: Text; var SIHdr: Record "Sales Cr.Memo Header")
//     var
//         JsonObject: JsonObject;
//         JsonArray: JsonArray;
//         JsonToken: JsonToken;
...
//         JsonObject.Get('status', JsonToken);
//         if JsonToken.AsValue().AsCode() = 'SUCCESS' then begin
//             SIHdr."E-Invoice API Status" := SIHdr."E-Invoice API Status"::Cancelled;
//             JsonObject.Get('response', JsonToken);
//             JsonObject := JsonToken.AsObject();
//             Clear(OutStr);
...
//                     OutStr.WriteText(JsonToken.AsValue().AsText());
//                 end;
//             end;
...
//     procedure CalculateShipToBillToOptions(var ShipToOptions: Option "Default (Sell-to Address)","Alternate Shipping Address","Custom Address"; var BillToOptions: Option "Default (Customer)","Another Customer","Custom Address"; var SalesHeader: Record "Sales Cr.Memo Header")
//     var
...
//     procedure ShipToAddressEqualsSellToAddress(var SalesHeader: Record "Sales Cr.Memo Header"): Boolean
//     begin
//         exit(IsShipToAddressEqualToSellToAddress(SalesHeader, SalesHeader));
//     end;

//     local procedure IsShipToAddressEqualToSellToAddress(SalesHeaderWithSellTo: Record "Sales Cr.Memo Header"; SalesHeaderWithShipTo: Record "Sales Cr.Memo Header"): Boolean
//     var
//         Result: Boolean;
//     begin
//         Result :=
