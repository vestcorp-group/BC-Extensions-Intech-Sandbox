// codeunit 60012 "Cancel EWB"//T12370-N //T12574-MIG USING ISPL E-Invoice Ext.
// {
...
//         EInvoiceSetup.TestField("Cancel EWB URL");
//         Clear(IsSuccess);
//         Clear(ResponseText);
//         Clear(IrisAPI);
//         Clear(Token);
...
//         Clear(IrisAPI);
//         IrisAPI.SetWebseriveProperties(EInvoiceSetup."Base URL" + EInvoiceSetup."Cancel EWB URL", BodyText, false, Token, CompanyId, true);
//         IrisAPI.Run();
//         IrisAPI.GetResponse(IsSuccess, ResponseText);
//         if IsSuccess then
...
//     begin
//         companyInfo.GET;
//         SCrMemoHdr.TestField("E-Invoice EWB No.");
...
//         JsonObject.Add('ewbNo', SCrMemoHdr."E-Invoice EWB No.");
//         JsonObject.Add('cnlRsn', '2');
...
//                 SCrMemoHdr."Cancel EWB Date" := dt;
//             end;
//             JsonObject.Get('ewbNo', JsonToken);
//             if not JsonToken.AsValue().IsNull then
//                 SCrMemoHdr."Cancel EWB No." := JsonToken.AsValue().AsText();
