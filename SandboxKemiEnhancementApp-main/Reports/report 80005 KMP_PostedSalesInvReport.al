...
report 80005 KMP_PostedSalesInvReport//T12370-N
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Layout_80005_KMP_PostedSalesInvoiceReport.rdl';
    Caption = 'Posted Sales Invoice-FZC';
            ...
            begin
                ...
                if Location_gRec.Get("Sales Invoice Header"."Location Code") then begin
                    ...
                    if Location_gRec.City <> '' then
                        Locationadd_gTxt := '<br/>' + Location_gRec.City;
                    if Location_gRec."Post Code" <> '' then
                        Locationadd_gTxt := '<br/>' + Location_gRec."Post Code" + ' ' + Location_gRec.County;
