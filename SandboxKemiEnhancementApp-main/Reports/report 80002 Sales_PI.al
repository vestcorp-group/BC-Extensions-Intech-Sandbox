// report 80002 "Sales_PI"//T12370-Full Comment
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/Layout_80002_SalesOrderReport.rdl';
//     Caption = 'Pro Forma Invoice / Sales Order Report';
//     dataset
//     {
...
//             column(CurrencyDescription; CurrencyDescription) { }
...
//             column(CompAddr4; CompanyInformation."Country/Region Code") { }
//             column(Telephone; CompanyInformation."Phone No.") { }
//             column(TRNNo; CompanyInformation."Registration No.") { }
...
//             column(Cust_TRN; CustAddr_Arr[9]) { }
...
//                 column(PINO; PINO)
//                 { }
//                 column(PIDate; FORMAT(PIDate, 0, '<Day,2>/<Month Text>/<Year4>')) { }
...
//                     // SalesHeaderRec.SetRange("No.", "Sales Line"."Blanket Order No.");
//                     // if SalesHeaderRec.FindFirst() then begin
//                     PINO := "Sales Line"."Blanket Order No.";
//                     PIDate := SalesHeaderRec."Order Date";
//                     // end
//                     // else begin
//                     //     PINO := "Document No.";
//                     //     PIDate := "Sales Header"."Order Date";
//                     // end;
//                     //UK::04062020<<
...
//                 DataItemTableView = WHERE("Document Type" = filter(Order), "Document Line No." = const(0));
...
//                         CustAddr_Arr[10] := CustAltAddrRec.PostCode; //gk
...
//                         CustAddr_Arr[10] := "Bill-to Post Code"; //GK
...
//                     if CustomInvoiceG then begin
//                         // if CustAltAddrRec.Get("Sales Header"."Sell-to Customer No.") then begin
//                         if "Customer Registration No." <> '' then
//                             CustAddr_Arr[8] := "Customer Registration Type" + ': ' + "Customer Registration No."
//                         else
//                             CustAddr_Arr[8] := '';
...
//                 // TranSec_Desc := TranSec_Desc + ', ' + Area_Rec.Text;   //Change
...
//     labels
//     {
//         RepHeader = 'Pro Forma Invoice';//'Pro Forma Invoice / Sales Order';
//         Ref_Lbl = 'P/I No.:';
//         Date_Lbl = 'P/I Date:';
...
//         TotalPayableinwords_Lbl = 'Total Payable in words'; ExchangeRate_Lbl = 'Currency exchange rate for VAT calculation:';
