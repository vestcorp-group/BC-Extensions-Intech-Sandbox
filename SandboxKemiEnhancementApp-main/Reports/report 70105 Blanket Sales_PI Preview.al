// report 70105 "Blanket Sales_PI Preview"//T12370-Full Comment
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/BSOPreview.rdl';
//     Caption = 'Pro Forma Invoice / Blanket Sales Order Report';
//     dataset
//     {
...
//                             if "Sales Line"."Allow Loose Qty." then
//                                 PackingText := format(Result) + ' ' + ItemUnitofMeasureL.Code
//                             else
//                                 PackingText := format(Result) + ' ' + ItemUnitofMeasureL.Code + ' of ' + Item_LRec."Description 2";
//                         end;
