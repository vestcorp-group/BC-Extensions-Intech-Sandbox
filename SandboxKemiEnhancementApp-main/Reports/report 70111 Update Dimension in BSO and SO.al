// report 70111 "Update Dimension in BSO and SO"//T12370-Full Comment
// {
//     UsageCategory = ReportsAndAnalysis;
//     AdditionalSearchTerms = 'My Processing Update Sales Data Report';
//     ApplicationArea = All;
...
//             begin
//                 SalesHeader_Rec.SETRANGE("No.", SalesHeader."No.");
//                 SalesHeader_Rec.SETFILTER("Document Type", '%1', SalesHeader."Document Type");
...
//                     IF (OldDimensionSetID <> NewDimSetID) and SalesLinesExist() THEN BEGIN
...
//                         SalesLine.RESET;
//                         SalesLine.SETRANGE("Document Type", SalesHeader_Rec."Document Type");
