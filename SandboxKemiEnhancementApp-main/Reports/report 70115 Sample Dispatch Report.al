report 70115 "Sample Dispatch Report"//T12370-Full Comment //12724
{
    UsageCategory = Administration;
    ApplicationArea = All;
    Caption = 'Sample Dispatch Report';
    DefaultLayout = RDLC;
    RDLCLayout = 'layouts/B Sample Dispatch Report.rdl';
    dataset
    {
            ...
            dataitem(SalesInvoiceLine; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    if (SalesInvoiceLine.Type = SalesInvoiceLine.Type::Item) and (ItemG.Get("No.")) then
                        ...
                        if (ItemG."Inventory Posting Group" <> 'SAMPLE') then
                            CurrReport.Skip();
            ...
            dataitem(SalesCreditMemoLine; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    if (SalesCreditMemoLine.Type = SalesCreditMemoLine.Type::Item) and (Item2G.Get("No.")) then
                        ...
                        if (Item2G."Inventory Posting Group" <> 'SAMPLE') then
                            CurrReport.Skip();
                    if CountryCodeG > '' then
