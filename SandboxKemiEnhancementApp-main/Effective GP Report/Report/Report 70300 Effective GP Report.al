report 70300 "Effective GP Report"//T12370-Full Comment T12946-Code Uncommented
{
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'Effective GP Report\EffectiveGPReport.rdl';
    dataset
    {
        dataitem(Companies; Company)
        {
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    column(CustShortName; Customer."Search Name") { }
                    column(CustCountry; Customer."Country/Region Code") { }
                    column(SPShortname; SalesPerson."Short Name") { }
                    column(ItemNo; "No.") { }
                    ...
                    column(EffectiveGPLCY; EffectiveGPLCY) { }
                                    ...
                                    IF ICSalesOrderInvoiceLines.FindFirst() THEN BEGIN
                                        REPEAT
                                            ...
                                            IF ICValueEntry.FINDFIRST THEN
                                                REPEAT
                                                    ICValueEntry2.RESET;
                                                    ICValueEntry2.SETRANGE("Document No.", ICSalesOrderInvoiceLines."Document No.");
                                                    ICValueEntry2.SETRANGE("Item Ledger Entry No.", ICValueEntry."Item Ledger Entry No.");
                                                    ICValueEntry2.SETFILTER("Item Charge No.", '<>%1', '');
                                                    ICValueEntry2.SETRANGE("Item No.", ICValueEntry."Item No.");
                                                    IF ChargeItemFilter <> '' THEN
                                                    ...
                                                    IF ICValueEntry2.FINDFIRST THEN
                                                        REPEAT
                                                            OtherRevenues += ICValueEntry2."Sales Amount (Actual)";
