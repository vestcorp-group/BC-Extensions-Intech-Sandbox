pageextension 70000 "Blanket sales Order Extension" extends "Blanket Sales Order"//T12370-Full Comment
{
    layout
    {
        addlast(content)
        {
            group(Remarks3)
            {
                ...
                {
                    SubPageLink = "Document Type" = const("Blanket Order"), "Document No." = field("No.");
                    ApplicationArea = all;
                }
            }
