// report 50103 "ISPL AGED AR V20240806"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/AgedAccountsReceivable_ISPL.rdl';
//     ApplicationArea = Basic, Suite;
//     Caption = 'ISPL AGED AR V20240806';
...
//                     DataItemTableView = sorting("Customer No.", "Posting Date", "Currency Code") where("Document Type" = filter(Invoice));
...
//                     {
//                         DataItemTableView = sorting(Number) where(Number = filter(1 ..));
//                         column(Name1_Cust; Customer."Search Name")
//                         {
//                             IncludeCaption = true;
//                         }
...
//                         {
//                         }
//                         column(PrePostedDocNo; PrePostedDocNo)
//                         {

//                         }
//                         column(PaidAmt_gDec; PaidAmt_gDec)
//                         {

//                         }
//                         column(InvoiceAmt_gDec; Customer."Invoice Amounts") // InvoiceAmt_gDec)
//                         {

//                         }
//                         column(InvoiceAmtLCY_gDec; Customer."Inv. Amounts (LCY)") // InvoiceAmtLCY_gDec)
//                         {
...
//                             OrignalAppliEntry_lRec: Record "Cust. Ledger Entry";
//                         begin
...
//                                 Clear(SH_lRec);
//                                 SH_lRec.SetRange("No.", SIH_lRec."Order No.");
//                                 if SH_lRec.FindFirst() then begin
//                                     PrePostedDocNo := SH_lRec."No.";
//                                     PostingDate_gDte := SH_lRec."Posting Date";
//                                 end else begin
//                                     Clear(SIL_lRec);
//                                     SIL_lRec.SetRange("Document No.", SIH_lRec."No.");
//                                     SIL_lRec.SetFilter("Shipment No.", '<>%1', '');
//                                     if SIL_lRec.FindFirst() then begin
//                                         Clear(SSL_lRec);
//                                         SSL_lRec.SetRange("Document No.", SIL_lRec."Shipment No.");
//                                         SSL_lRec.SetRange("Line No.", SIL_lRec."Shipment Line No.");
//                                         if SSL_lRec.FindFirst() then begin
//                                             PrePostedDocNo := SSL_lRec."Order No.";
//                                             PostingDate_gDte := SSL_lRec."Posting Date";
//                                         end;
//                                     end;
//                                 end;

//                                 if PrePostedDocNo = '' then begin
//                                     PrePostedDocNo := SIH_lRec."Order No.";
//                                     PostingDate_gDte := SIH_lRec."Posting Date";
//                                 end;

//                                 if PrePostedDocNo = '' then begin
//                                     PrePostedDocNo := SIH_lRec."Pre-Assigned No.";
//                                     PostingDate_gDte := SIH_lRec."Posting Date";
//                                 end;
...
//                             AppliedCustomerLedEntry_gRec.Reset;

//                             if OrignalAppliEntry_lRec."Entry No." <> 0 then begin
//                                 FindApplnEntriesDtldtLedgEntry;
//                                 AppliedCustomerLedEntry_gRec.SetCurrentkey("Entry No.");
//                                 AppliedCustomerLedEntry_gRec.SetRange("Entry No.");


//                                 if OrignalAppliEntry_lRec."Closed by Entry No." <> 0 then begin
//                                     AppliedCustomerLedEntry_gRec."Entry No." := OrignalAppliEntry_lRec."Closed by Entry No.";
//                                     AppliedCustomerLedEntry_gRec.Mark(true);
//                                 end;

//                                 AppliedCustomerLedEntry_gRec.SetCurrentkey("Closed by Entry No.");
//                                 AppliedCustomerLedEntry_gRec.SetRange("Closed by Entry No.", OrignalAppliEntry_lRec."Entry No.");
//                                 if AppliedCustomerLedEntry_gRec.Find('-') then
//                                     repeat
//                                         AppliedCustomerLedEntry_gRec.Mark(true);
//                                     until AppliedCustomerLedEntry_gRec.Next = 0;

//                                 AppliedCustomerLedEntry_gRec.SetCurrentkey("Entry No.");
//                                 AppliedCustomerLedEntry_gRec.SetRange("Closed by Entry No.");
//                             end;

//                             PaidAmt_gDec := 0;
//                             AppliedCustomerLedEntry_gRec.MarkedOnly(true);
//                             if AppliedCustomerLedEntry_gRec.FindSet() then begin
//                                 repeat
//                                     AppliedCustomerLedEntry_gRec.CalcFields(Amount);
//                                     PaidAmt_gDec += AppliedCustomerLedEntry_gRec.Amount;
//                                 until AppliedCustomerLedEntry_gRec.Next = 0;
//                             end;

//                             Clear(OverDueDays_gInt);
//                             if Today >= CustLedgEntryEndingDate."Due Date" then
//                                 OverDueDays_gInt := Today - CustLedgEntryEndingDate."Due Date";

//                             Clear(OverduedStyle_gTxt);
//                             if OverDueDays_gInt <= 0 then
//                                 //OverduedStyle_gTxt := 'Green'
...
//                 trigger OnPreDataItem()
//                 begin
//                     if CustomerPostingGrp_gTxt <> '' then
//                         Customer.SetFilter("Customer Posting Group", CustomerPostingGrp_gTxt);
//                 end;
//             }
...
//                     }
//                     field(CustomerPostingGrp_gTxt; CustomerPostingGrp_gTxt)
//                     {
//                         ApplicationArea = All;
...
//         InvoiceAmtLCY_gDec, InvoiceAmt_gDec, PaidAmt_gDec : Decimal;
//         EndingDate, PostingDate_gDte : Date;
//         PrePostedDocNo: Code[35];
...
//         PageGroupNo, OverDueDays_gInt : Integer;
...
//         AppliedCustomerLedEntry_gRec: Record "Cust. Ledger Entry";
//         OverduedStyle_gTxt: Text;
//         CustomerPostingGrp_gTxt: Text;
...
//                             then begin
//                                 AppliedCustomerLedEntry_gRec.SetCurrentkey("Entry No.");
//                                 AppliedCustomerLedEntry_gRec.SetRange("Entry No.", DtldCustLedgEntry2."Cust. Ledger Entry No.");
//                                 if AppliedCustomerLedEntry_gRec.Find('-') then
//                                     AppliedCustomerLedEntry_gRec.Mark(true);
//                             end;
...
//                 end else begin
//                     AppliedCustomerLedEntry_gRec.SetCurrentkey("Entry No.");
//                     AppliedCustomerLedEntry_gRec.SetRange("Entry No.", DtldCustLedgEntry1."Applied Cust. Ledger Entry No.");
//                     if AppliedCustomerLedEntry_gRec.Find('-') then
//                         AppliedCustomerLedEntry_gRec.Mark(true);
//                 end;
