// report 50100 "ISPL AGED AP V20240806"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/AgedAccountsPayable_ISPL.rdl';
//     ApplicationArea = All;
//     Caption = 'ISPL AGED AP V20240806';
...
//                 {
//                     DataItemTableView = sorting(Number) where(Number = filter(1 ..));
//                     column(VendorName; Vendor."Search Name")
//                     {
//                     }
...
//                     }
//                     column(InvoiceAmt_gDec; Vendor."Invoice Amounts") // InvoiceAmt_gDec)
//                     {

//                     }
//                     column(InvoiceAmtLCY_gDec; Vendor."Inv. Amounts (LCY)") // InvoiceAmtLCY_gDec)
//                     {
...
//                                         PostingDate_gDte := PRL_lRec."Posting Date";
//                                     end;
//                                 end;
//                             end;
...
//                                 PostingDate_gDte := PIH_lRec."Posting Date";
//                             end;
...
//                         Clear(PaidAmt_gDec);
//                         Clear(VLE_lRec);
//                         VLE_lRec.SetRange("Entry No.", VendorLedgEntryEndingDate."Entry No.");
...
//                         if AppliedVendorLedEntry_gRec.FindSet() then begin
//                             repeat
//                                 AppliedVendorLedEntry_gRec.CalcFields(Amount);
//                                 PaidAmt_gDec += AppliedVendorLedEntry_gRec.Amount;
//                             until AppliedVendorLedEntry_gRec.Next = 0;
//                         end;

//                         Clear(OverDueDays_gInt);
//                         if Today >= VendorLedgEntryEndingDate."Due Date" then
//                             OverDueDays_gInt := Today - VendorLedgEntryEndingDate."Due Date";
...
//                     Vendor.SetFilter("Vendor Posting Group", CustomerPostingGrp_gTxt);
//             end;
//         }
...
//         GrandTotalVLEAmtLCY, InvoiceAmt_gDec, InvoiceAmtLCY_gDec, PaidAmt_gDec : Decimal;
...
//         TodayFormatted, OverduedStyle_gTxt : Text;
//         CompanyDisplayName: Text;
//         DocNoCaption: Text;
//         DocumentNo, PrePostedDocNo : Code[35];
...
//     procedure FindApplnEntriesDtldtLedgEntry(VLE_iRec: Record "Vendor Ledger Entry")
//     var
