// Codeunit 75000 "Re-Open Production Order" //T13754-NS already in Intech Dev -full Comment
// {
...
//         ProdOrderRoutingLine_lRec.SetRange("Routing No.", FinishProOrder_iCod);
//         IF ProdOrderRoutingLine_lRec.FINDSET THEN BEGIN
//             REPEAT
//                 ModProdOrderRoutingLine_lRec.GET(ProdOrderRoutingLine_lRec."Routing No.", ProdOrderRoutingLine_lRec."Routing Reference No.", ProdOrderRoutingLine_lRec."Operation No.");
//                 ModProdOrderRoutingLine_lRec.Status := ModProdOrderRoutingLine_lRec.Status::Released;
//                 ModProdOrderRoutingLine_lRec.Modify();
