pageextension 75022 Posted_Transfer_Receipt_75022 extends "Posted Transfer Receipt"
{
    layout
    {
        addlast(General)
        ...
        addafter("&Print")
        {
            action("View Tax Transcation Entries")
            {
                ...
                var
                    ...
                    TRL_lRec: Record "Transfer Receipt Line";
                begin
                    TaxTrnasactionValue.Reset();
                    TRL_lRec.RESET;
                    TRL_lRec.Setrange("Document No.", Rec."No.");
                    IF TRL_lRec.FindSet() Then begin
                        repeat
                            TaxTrnasactionValue.SetRange("Tax Record ID", TRL_lRec.RecordId);
    ...
    begin
        ...
        INTTransferStastistics.GetStatisticsAmountTransferReceiptHeader(Rec, GSTAmount_gDec);
