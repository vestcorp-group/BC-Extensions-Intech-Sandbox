pageextension 75014 Posted_Purch_Credit_Memo_75014 extends "Posted Purchase Credit Memo"
{
    layout
    {
        addlast(General)
        ...
        addafter("&Cr. Memo")
        {
            action("View Tax Transcation Entries")
            {
                ...
                var
                    ...
                    PCrMemoL_lRec: Record "Purch. Cr. Memo Line";
                begin
                    TaxTrnasactionValue.Reset();
                    PCrMemoL_lRec.RESET;
                    PCrMemoL_lRec.Setrange("Document No.", Rec."No.");
                    IF PCrMemoL_lRec.FindSet() Then begin
                        repeat
                            TaxTrnasactionValue.SetRange("Tax Record ID", PCrMemoL_lRec.RecordId);
    ...
    begin
        ...
        CalcStatistics_gCdu.GetPostedPurchCrMemoStatisticsAmount(Rec, AmountToVendor_gDec);
