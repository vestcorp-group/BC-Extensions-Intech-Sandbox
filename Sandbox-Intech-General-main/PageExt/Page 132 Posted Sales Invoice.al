pageextension 75011 Posted_Sales_Invoice_75011 extends "Posted Sales Invoice"
{
    layout
    {
        addlast(General)
        ...
        addafter(Print)
        {
            action("View Tax Transcation Entries")
            {
                ...
                begin
                    ...
                    SIL_lRec.RESET;
                    SIL_lRec.Setrange("Document No.", Rec."No.");
                    IF SIL_lRec.FindSet() Then begin
                        repeat
                            TaxTrnasactionValue.SetRange("Tax Record ID", SIL_lRec.RecordId);
    ...
    begin
        ...
        CalcStatistics_gCdu.GetPostedSalesInvStatisticsAmount(Rec, AmountToCustomer_gDec);
