pageextension 74982 Fixed_Asset_List_P74982 extends "Fixed Asset List"
{
    actions
    {
        addafter("Co&mments")
    ...
    begin
        ...
        foreach EntryListKey in EntryList do begin
            ...
            if not FixedAsset.Get(FileName) then
    ...
    begin
        ...
        foreach EntryListKey in EntryList do begin
            ...
            FixedAsset.Image.ImportStream(EntryInStream, FileMgt.GetFileName(EntryListKey));
            FixedAsset.Modify();
        end;
