pageextension 74984 Item_List_74984 extends "Item List"
{
    actions
    {
        addafter("Co&mments")
    ...
    begin
        ...
        foreach EntryListKey in EntryList do begin
            ...
            Item.Picture.ImportStream(EntryInStream, FileMgt.GetFileName(EntryListKey));
            Item.Modify();
        end;
